export const features = [
  {
    ...
    text: "Asbionix offers smart home automation with seamless control over lighting, security, and climate through an intuitive mobile-friendly interface. Enjoy enhanced comfort, safety, and efficiency tailored to your lifestyle.",
    button: {
  ...
  },
  {
    ...
    caption: " SMART INSTITUTION",
    title: "Tech meets Education",
    text: "Transform your institution with Asbionix—smart automation, security, networking, and AV solutions for schools, colleges, and corporates. Boost efficiency, safety, and connectivity with our future-ready technology.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "What is Asbionix and what do you offer?",
    answer:
      "Asbionix specializes in home automation, security systems, networking solutions, multiroom audio, and smart institution technology—designed to make living and working spaces smarter, safer, and more efficient.",
  },
  {
    id: "1",
    question: "Can I control everything from my phone?",
    answer:
      "Yes! Asbionix provides a user-friendly graphical interface accessible via your mobile phone, iPad, or touch panel for seamless control of lighting, HVAC, curtains, security, and more.",
  },
  {
    id: "2",
    question: "Do you provide solutions for institutions as well?",
    answer:
      "Absolutely. We offer automation, security, networking, and AV solutions for schools, colleges, and corporate institutions—including automated attendance, smart classrooms, access control, and more.",
  },
  {
    id: "3",
    question: "What happens if there's a power outage?",
    answer:
      "Our systems are designed with reliability in mind. Backup and fail-safe measures ensure critical systems like security and networking remain operational during outages.",
  },
  {
    id: "4",
    question: "Can I automate lighting and curtains based on time of day?",
    answer:
      "Yes! Our curtain and lighting systems support scheduled settings, enabling you to automate actions like opening curtains or dimming lights to match your daily routine.",
  },
  {
    id: "5",
    question: "Is the home theatre customizable?",
    answer:
      "Definitely. We design home theaters tailored to your space and preferences—offering immersive sound, high-definition visuals, and acoustic treatments for the ultimate viewing experience.",
  },
  {
    id: "6",
    question: "What kind of networking solutions do you offer?",
    answer:
      "We provide robust, high-speed networking with indoor and outdoor Access Points to eliminate dead zones and deliver consistent connectivity across your property.",
  },
  {
    id: "7",
    question: "Can I integrate security cameras and smart locks?",
    answer:
      "Yes. Our security systems include surveillance cameras, smart locks, and sensor-based protection with real-time monitoring and remote control capabilities via our mobile app.",
  },
  {
    id: "8",
    question: "Do you support multi-room audio?",
    answer:
      "Yes! Our multiroom audio system lets you play music in different zones simultaneously or control each room independently with crystal-clear sound and flexible control.",
  },
  {
    id: "9",
    question: "How do I get started with Asbionix?",
    answer:
      "Just reach out to us via phone or email. We’ll guide you through a customized consultation to understand your needs and create a smart system that fits your space.",
  },
];
...
export const testimonials = [
  {
    id: "0",
    name: "A Subash Bharathi",
    role: "CEO & Founder",
    avatarUrl: "/images/testimonials/asb.jpg",
  },
  {
    id: "1",
    name: "Narendran G K",
    role: "Technical Designer",
    avatarUrl: "/images/testimonials/naren.jpg",
  }
];
...
export const socials = [
  ...
  },
  {
    id: "1",
    title: "Email",
    icon: "/images/socials/mail.svg",
    url: "mailto:asbionix@gmail.com",
  },
  {
    id: "2",
    title: "Instagram",
    icon: "/images/socials/instagram.svg",
    url: "https://www.instagram.com/asbionix",
  },
];
